...
const RegisterPage = () => {
    ...
    return (
        <div className="container mt-5 text-center">
            <h1 className="text-4xl text-gray-800">Register for Receipe sharing application!</h1>
            <h4 className="text-xl text-gray-600">A simple Receipe sharing application</h4>
